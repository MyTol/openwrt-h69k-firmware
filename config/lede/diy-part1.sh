...
## 风扇降噪补丁
git clone --depth=1 https://github.com/MyTol/h69k-fanctrl package/fanctrl
## 风扇强冷补丁
...
git clone --depth=1 https://github.com/wangqn/luci-app-filebrowser package/feeds/luci/luci-app-filebrowser
