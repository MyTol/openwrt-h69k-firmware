...
### luci-app-modem
sed -i 's/msgstr "移动通信模组"/msgstr "移动通信"/g' package/wwan/modem/luci-app-modem/po/zh-cn/modem.po
sed -i 's/msgstr "网络模式"/msgstr "网络模式 (Network Mode)"/g' package/wwan/modem/luci-app-modem/po/zh-cn/modem.po
### luci-app-turboacc
